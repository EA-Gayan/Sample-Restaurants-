    ...
    flex-col z-[101]'>
      ...
      <motion.div whileTap={{scale:0.75}} onClick={showCart}>
        ...
        <motion.p 
          ...
          hover:shadow-md cursor-pointer text-textColor text-base' onClick={clearCart}>
          Clear<RiRefreshFill/>
          </motion.p>
      </div>
      ...
      gap-3 overflow-y-scroll scrollbar-none'>
        ...
        <div className='w-full flex items-center justify-between'>
          <p className='text-gray-400 text-lg'>Delivery Total</p>
        ...
        <div className='w-full flex items-center justify-between'>
          ...
          <p className='text-gray-200 text-xl font-semibold'>Rs{tot+100}</p>
        </div>
